  ...
  <div class="shop-header">
    ...
    <div class="shop-content">
      ...
      <div class="header-content">
        <h2 class="content-title" @click="isShownButtlin=true">
    ...
    <div class="shop-header-discounts" v-if="info.supports" @click="isShownSupports=true">
    ...
    <div class="shop-brief-modal" v-show="isShownButtlin">
      <div class="brief-modal-content" >
        ...
        <div class="mask-footer" @click="isShownButtlin = false">
          <span class="iconfont icon-close"></span>
        </div>
      </div>
      <div class="brief-modal-cover"></div>
    </div>
    <div class="activity-sheet" v-show="isShownSupports">
      <div class="activity-sheet-content">
        ...
        <div class="activity-sheet-close" @click="isShownSupports = false">
          <span class="iconfont icon-close"></span>
        </div>
      </div>
    ...
    data(){
      return {
       supportClasses: ['activity-green','activity-red','activity-orange'],
        isShownButtlin: false,
        isShownSupports: false
      }
    },
   computed: {
     ...mapState(['info'])
